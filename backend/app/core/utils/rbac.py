...
class Permissions:
    ...
    MANAGE_FORECASTS = "manage_forecasts"
    VIEW_SEASONAL_PATTERNS = "view_seasonal_patterns"
    MANAGE_SEASONAL_PATTERNS = "manage_seasonal_patterns"
    MANAGE_AUTO_ORDERS = "manage_auto_orders"
